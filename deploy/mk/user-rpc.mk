...
# 测试环境配置
# docker的镜像发布地址
DOCKER_REPO_TEST=crpi-l7tvpukszv54yebz.cn-hangzhou.personal.cr.aliyuncs.com/binghu-easy-chat/${SERVER_NAME}-${SERVER_TYPE}-dev
# 测试版本
VERSION_TEST=$(VERSION)
# 编译的程序名称
APP_NAME_TEST=binghu-easy-chat-${SERVER_NAME}-${SERVER_TYPE}-dev
